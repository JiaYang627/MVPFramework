 ...
 */
package com.jiayang.commonlibs.commonListAdapter;
...
//        ImageLoader.loadListBitmapFromUrl(imageUrl , view);
        return this;
    }
    public BaseAdapterHelper setAvatarImageUrl(int viewId, String imageUrl) {
        ImageView view = retrieveView(viewId);
//        ImageLoader.loadAvatarFromUrl(imageUrl , view);
        return this;
    }

    public BaseAdapterHelper setListBitmapImageUrl(int viewId, String imageUrl) {
        ImageView view = retrieveView(viewId);
//        ImageLoader.loadListBitmapFromUrl(imageUrl , view);
        return this;
    }
