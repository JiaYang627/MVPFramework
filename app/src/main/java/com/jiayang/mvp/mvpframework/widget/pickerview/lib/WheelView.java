...
import com.jiayang.mvp.mvpframework.widget.pickerview.adapter.WheelAdapter;
import com.jiayang.mvp.mvpframework.widget.pickerview.listener.OnItemSelectedListener;
import com.jiayang.mvp.mvpframework.widget.pickerview.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(label) && isCenterLabel) {
            ...
            canvas.drawText(label, drawRightContentStart - CENTER_CONTENT_OFFSET- (timeChange ? 100f:0f), centerY, paintCenterText);
        }
